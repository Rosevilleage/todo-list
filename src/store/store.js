...
const deleteSlice = createSlice({
	...
	reducers: {
		deleteTrigger: (state, action) => {state.value = action.payload}
	}
})
...
const loadSlice = createSlice({
	...
	initialState: {value: false},
	reducers: {
		trigger: (state, action) => {state.value = !state.value}
	}
})
...
const isAddSlice = createSlice({
	...
	initialState: {value: false},
	reducers: {
		addOn: (state, action) => {state.value = true},
		addOff: (state, action) => {state.value = false}
	}
})
